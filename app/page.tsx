    ...
    <div className="min-h-screen bg-cover bg-center bg-no-repeat" style={{ backgroundImage: 'url("/img/background.png")' }}>
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl md:text-6xl font-bold text-yellow-300 drop-shadow-lg mb-4" style={{ textShadow: '2px 2px 0 #2563eb, 4px 4px 0 #1d4ed8' }}>
            PokéScratch
          </h1>
          <p className="text-white text-xl mb-4 drop-shadow-lg">Scratch the card and guess the Pokémon!</p>
